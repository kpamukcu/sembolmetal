            ...
            <div class="col-12">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-aluminyum-tab" data-toggle="pill" data-target="#pills-aluminyum" type="button" role="tab" aria-controls="pills-aluminyum" aria-selected="true">Alüminyum</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-demir-tab" data-toggle="pill" data-target="#pills-demir" type="button" role="tab" aria-controls="pills-demir" aria-selected="false">Demir</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-paslanmaz-tab" data-toggle="pill" data-target="#pills-paslanmaz" type="button" role="tab" aria-controls="pills-paslanmaz" aria-selected="false">Paslanmaz</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-pirinc-tab" data-toggle="pill" data-target="#pills-pirinc" type="button" role="tab" aria-controls="pills-pirinc" aria-selected="false">Prinç</button>
                    </li>
                </ul>
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-aluminyum" role="tabpanel" aria-labelledby="pills-aluminyum-tab">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php
                                $profilList = $db->prepare('select * from profilekle where malTuru="Alüminyum" order by ebat');
                                $profilList->execute();
                    ...
                    <div class="tab-pane fade" id="pills-demir" role="tabpanel" aria-labelledby="pills-demir-tab">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php
                                $profilList = $db->prepare('select * from profilekle where malTuru="Demir" order by ebat');
                                $profilList->execute();
                    ...
                    <div class="tab-pane fade" id="pills-paslanmaz" role="tabpanel" aria-labelledby="pills-paslanmaz-tab">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php
                                $profilList = $db->prepare('select * from profilekle where malTuru="Paslanmaz" order by ebat');
                                $profilList->execute();
                    ...
                    <div class="tab-pane fade" id="pills-pirinc" role="tabpanel" aria-labelledby="pills-pirinc-tab">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php
                                $profilList = $db->prepare('select * from profilekle where malTuru="Pirinç" order by ebat');
                                $profilList->execute();
