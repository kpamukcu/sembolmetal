        ...
        <div class="row">
            <div class="col-12">
                ...
                <p>
                    ...
                    SEMBOL METAL SAN.TİC.LTD.ŞTİ. olarak sitemizde ve uygulamamızda kullandığımız çerezleri kullanmaktan vazgeçebilir, bunların türlerini veya fonksiyonlarını değiştirebilir veya sitemize ve uygulamamızda yeni çerezler ekleyebiliriz. Dolayısıyla işbu Çerez Aydınlatma Metni’nin hükümlerini dilediğimiz zaman değiştirme hakkını saklı tutarız. Güncel Çerez Aydınlatma Metni üzerinde gerçekleştirilmiş olan her türlü değişiklik sitede, uygulamada veya herhangi bir kamuya açık mecrada yayınlanmakla birlikte yürürlük kazanacaktır. Son güncelleme tarihini metnin sonunda bulabilirsiniz.

                    Kişisel verilerinizin Şirketimiz tarafından işlenme amaçları konusunda detaylı bilgilere [https://www.leta.com.tr/kisisel-verilerin-korunmasi] yer alan SEMBOL METAL SAN.TİC.LTD.ŞTİ Kişisel Verilerin Korunması ve İşlenmesi Politikası’ndan ulaşabilirsiniz. </p>

                <strong>Kişisel Veri Toplamanın Yöntemi ve Hukuki Sebebi</strong>
                <p> Kişisel verileriniz, internet sitemizi ziyaretiniz kapsamında veya uygulamamızı kullanmanız dolayısıyla elektronik ortamda çerezler yoluyla Şirketimizin meşru menfaatine yönelik hukuki sebebe dayalı olarak toplanmaktadır. Hedefleme ve profilleme vasıtasıyla gerçekleştirilen pazarlama ve reklamcılık faaliyetleri ise yalnızca açık rızanız olması halinde gerçekleştirilmektedir. Toplanan kişisel verileriniz Kanun’un 5. ve 6. maddelerinde belirtilen kişisel veri işleme şartları ve amaçları kapsamında işbu Çerez Aydınlatma Metni’nde belirtilen amaçlarla da işlenebilmektedir.

                    Kişisel Verilerin Kimlere ve Hangi Amaçla Aktarılabileceği
                    SEMBOL METAL SAN.TİC.LTD.ŞTİ olarak, Çerez Aydınlatma Metni kapsamındaki kişisel verilerinizi yukarıda belirtilen amaçların gerçekleştirilebilmesi ile sınırlı olarak ve mevzuata uygun şekilde tedarikçilerimize, kanunen yetkili kamu kurumlarına ve özel kişilere paylaşabiliriz</p>

                <strong>Hangi Çerezler Hangi Amaçlarla Kullanılmaktadır?</strong>
                <p> Genel Olarak

                    SEMBOL METAL SAN.TİC.LTD.ŞTİ. olarak sitemizde çeşitli amaçlarla çerezler kullanmakta ve bu çerezler vasıtasıyla kişisel verilerinizi işlemekteyiz. Bu amaçlar başlıca şunlardır:</p>
                ...
                <p> Çerez ve benzeri teknolojilerin kullanımı konusunda ziyaretçi ve kullanıcılarımızın tercihleri bizler için esastır. Buna karşın, Platform’un çalışması için zorunlu olan Çerezler’in kullanılması gerekmektedir. Ek olarak bazı çerezlerin kapatılması halinde Platform’un birtakım işlevlerinin kısmen ya da tamamen çalışmayabileceğini hatırlatmak isteriz.
                    ...
                    AOL <a href=" https://help.aol.com/articles/restore-security-settings-and-enable-cookie-settings-on-browser"> https://help.aol.com/articles/restore-security-settings-and-enable-cookie-settings-on-browser</a><br>

                    Google Adwords <a href=" https://support.google.com/ads/answer/2662922?hl=en"> https://support.google.com/ads/answer/2662922?hl=en</a><br>

                    Google Analytics <a href="https://tools.google.com/dlpage/gaoptout">https://tools.google.com/dlpage/gaoptout</a> <br>

                    Google Chrome <a href="http://www.google.com/support/chrome/bin/answer.py?hl=en&answer=95647">http://www.google.com/support/chrome/bin/answer.py?hl=en&answer=95647</a><br>

                    Internet Explorer <a href="https://support.microsoft.com/en-us/help/17442/windows-internet-explorer-delete-manage-cookies">https://support.microsoft.com/en-us/help/17442/windows-internet-explorer-delete-manage-cookies</a> <br>

                    Mozilla Firefox <a href="http://support.mozilla.com/en-US/kb/Cookies">http://support.mozilla.com/en-US/kb/Cookies</a><br>
                    ...
                    Safari: <a href="https://support.apple.com/kb/ph19214?locale=tr_TR">https://support.apple.com/kb/ph19214?locale=tr_TR</a></p>
